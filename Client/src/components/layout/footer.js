  ...
  return (
    <div className='bg-[#222222] text-[#ccc] w-full mt-10'>
      <div className='bg-[#2B2B2B] flex justify-center items-center w-full h-9' >
        <span className="cursor-pointer hover:text-white transition">Điều khoản sử dụng</span>
        <span className='lg:mx-10 phone:mx-5 cursor-pointer hover:text-white transition'>DCMA</span>
        <span className="cursor-pointer hover:text-white transition">Chính sách bảo mật</span>
      </div>
